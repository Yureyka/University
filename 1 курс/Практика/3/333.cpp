...
int menu()
{
    ...
    do
    {
            ...
            cout<<"==========ДЕРЕВЬЯ==========="<<endl;
            cout<<((point==0)?'>':' ')<<"1- Добавить элемент в дерево"<<endl;
            cout<<((point==1)?'>':' ')<<"2- Отобразить структуру дерева"<<endl;
            cout<<((point==2)?'>':' ')<<"3- Просмотр дерева"<<endl;
            cout<<((point==3)?'>':' ')<<"4- Подсчет узлов с одним потомком"<<endl;
            cout<<((point==4)?'>':' ')<<"5- Запись данных в файл"<<endl;
            cout<<((point==5)?'>':' ')<<"6- Удаление дерева"<<endl;
            cout<<((point==6)?'>':' ')<<"7- Выход"<<endl;
            cout<<"============================"<<endl;
            key=getch();
    } while (key!=13 && key!=27);
    system("CLS");
