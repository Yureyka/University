<main>
    ...
    <div class="default-container contact-container clearfix">
        ...
        <div class="feedback-form alone">
            <form action="/admin/blogEditor" enctype="multipart/form-data" method="POST" name="form">
                <div class="test">
                    ...
                    <ul id="blogMessage">
                        <?php foreach ($parameters['tableData'] as $key => $post):
                            if ($post['theme'] != "") {
                                ...
                                <b>Тема сообщения:</b>
                                <li id="themeText<?= $post['id']; ?>"><?= $post['theme']; ?></li>
                                <li><img src="<?= $path ?>"></li>
                                <b>Сообщение:</b>
                                <li id="postText<?= $post['id']; ?>"><?= $post['message'] ?></li>
                                <li><?= $post['dateTime'] ?></li>
                                <li>
                                    <button type="button" style="background: #c5b7db; font-size: 28px" class="editPostButton" value="<?= $post['id']; ?>">Изменить</button>
                                </li>
                            <? }
                        endforeach; ?>
                    </ul>
                    ...
                    <ul id="pagination">
                        <li>
                            ...
                            for ($i = 0; $i < $numOfPages; $i++) {
                                ...
                                echo "<a id='pagination' href='/admin/blogEditor?page=$page'>$limitString</a>";
                            } ?>
                        </li>
                    </ul>
            </form>
