...
class SqlBuilder {
    ...
    public static $selectQueryByCommentId ='SELECT %s FROM `%s` WHERE postId=?';
    ...
    public static $selectQueryByUserId =  'SELECT %s FROM %s WHERE fio=?';
    public static $updateQuery =       'UPDATE `%s` SET %s WHERE id=?';
    public static $selectQueryDateDesc =  'SELECT %s FROM `%s` ORDER BY %s DESC';
    public static $updateQueryPost = 'UPDATE `%s` SET %s WHERE id=?';
    public static $selectQueryByUserComments = 'SELECT %s FROM `%s` INNER JOIN %s ON %s WHERE postId=?';
