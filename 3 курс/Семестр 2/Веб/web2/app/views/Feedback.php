<main>
    <h1>Загрузка сообщений гостевой книги</h1>
            ...
            <div class="feedback-form alone">
                <form action="/feedback/index" enctype="multipart/form-data" method = "POST" name = "form" onsubmit=" if (validateContactsForm()==false){return false;}else{return true}"  onchange="activate()">
                    <div class="test">
