    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            if (fileName == "" && textBox1.Text != "")
                e.Cancel = MessageBox.Show("Вы хотите выйти без сохранения?", "Выход", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.No;
        ...
        {
            MessageBox.Show("Notepad", "О программе", MessageBoxButtons.OK,
