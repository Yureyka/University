...
namespace WindowsFormsApp2
{
    public partial class MainForm : Form
    {
        ...
        private void посмотретьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Publisher t = (Publisher)table.DataGridView.CurrentRow?.DataBoundItem;
            if (t != null)
            {
            ...
            {
                MessageBox.Show("Не выбрана книга!", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Hand);
            }
        }
        ...
        private void удалитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Publisher t = (Publisher)currentRow?.DataBoundItem;
            if (t != null)
            {
                table.pubs.Remove(t);
            }
        ...
        private void редактироватьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (t != null)
            {
                int index = table.pubs.IndexOf(t);
                using (EditForm editForm = new EditForm(t))
                {
                    var result = editForm.ShowDialog();
                    if (result == DialogResult.OK)
                    {
                        table.pubs[index] = editForm.Result;
                    }
                }
            }
            else
        ...
        {
            MessageBox.Show("Лабораторная работа №4", "О программе", MessageBoxButtons.OK, MessageBoxIcon.Asterisk, MessageBoxDefaultButton.Button1);
        }
        ...
        private void открытьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                try
                {
                    ...
                    fields = (Publisher[])formatter.Deserialize(fs);
                }
                catch (IOException)
                {
                    return;
        ...
        private void сохранитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (dialog.ShowDialog() == DialogResult.OK)
            {
                ...
                formatter.Serialize(fs, table.pubs.ToArray());
                fs.Close();
            }
        }
